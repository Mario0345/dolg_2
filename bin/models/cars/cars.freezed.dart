...
abstract class $CarsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String car_color, String price, bool availability});
}
...
class _$CarsImpl implements _Cars {
  ...
  @override
  String toString() {
    return 'Cars(car_color: $car_color, price: $price, availability: $availability)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, car_color, price, availability);
